...
const CaterSubscriptions = () => {
  ...
  useEffect(() => {
    dispatch(fetchVendorSubscriptionList("Caterer"));
  }, [dispatch]);
        ...
        <div className="row mb-4  me-2">
          <div className="d-flex justify-content-between align-items-center">
            <h1 className="header-title">
              Caterer Subscription Plans List - {vendorSubscriptionList?.length}
            </h1>
...
export default CaterSubscriptions